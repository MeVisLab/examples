...
### Testing
The *MeVisLab TestCenter* is the starting point of your tests. Select {{<menuitem "File" "Run TestCaseManager" >}} or press {{< keyboard "Ctrl" "Alt" "T">}} to open the user interface of the `TestCaseManager`.
