...
The above list contains an identifier for the test case (*ProbandT1/2*), the file name(s) and a number value. The number value is the value of the DICOM tag (0028,1050) WindowCenter for each file.
