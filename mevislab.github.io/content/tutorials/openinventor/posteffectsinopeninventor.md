...
![How to create a scene object out of a multi-frame DICOM](images/tutorials/openinventor/multiframetoso.PNG "How to create a scene object out of a multi-frame DICOM")
...
![Grouped modules](images/tutorials/openinventor/GroupedModules.PNG "Grouped modules")
...
![Varying settings of colored edges, mode: Roberts](images/tutorials/openinventor/Edges2.PNG "Varying settings of colored edges, mode: Roberts")
![Varying settings of colored edges, mode: Sobel](images/tutorials/openinventor/Edges3.PNG "Varying settings of colored edges, mode: Sobel")
...
{{</alert>}}
 ...
 ![Network with additional opaque and transparent geometry](images/tutorials/openinventor/WorkspaceAndNetwork.PNG "Network with additional opaque and transparent geometry")

### PostEffectGlow
To put a soft glow on the geometrical scene objects, the module `SoPostEffectGlow` can be added to the workspace. 

![Applied SoPostEffectGlow](images/tutorials/openinventor/WorkspaceWithGlow.PNG "Applied SoPostEffectGlow")
