...
### MeVisLab GUI Editor
MATE also provides a powerful GUI Editor showing a preview of your current user interface and allowing to re-order elements in the UI via drag and drop. In MATE open {{< menuitem "Extras" "Enable GUI Editor" >}}.
...
{{<alert class="info" caption="Info">}}
If the GUI Editor is not shown in MATE, make sure to check *[Extras &rarr; Enable GUI Editor]*.
{{</alert>}}
