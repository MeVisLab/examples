...
Select output of the `Threshold` module to see the binary image in OutputInspector.
...
The `SoView2DOverlay` module is not intended to work with `OrthoView2D`; in this case, use a `GVROrthoOverlay` or `SoView2DOverlayMPR`.
{{</alert>}}
